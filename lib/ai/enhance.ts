...
export async function enhanceTranscript(
  ...
  const system =
    ...
    "Create a specific, natural title of roughly 4 to 12 words that reflects the main outcome or topic; avoid dates, filenames, generic labels, and trailing punctuation. " +
